...
class AccountingAgent(BaseTool):
    name = "AccountingAgent"
    description = "The AccountingAgent is used to represent current balances in hours for an employee's Time Off plan. I take input in a natural language format.\
